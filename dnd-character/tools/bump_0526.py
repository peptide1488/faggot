...
assert "_blastTilesAround" in (root / "iso3d" / "src" / "host.js").read_text(encoding="utf-8")
assert "blastLocked" in idx.read_text(encoding="utf-8")
assert "aoeR" in (root / "iso3d" / "src" / "adapter.js").read_text(encoding="utf-8")
