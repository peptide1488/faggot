...
assert "_drawBillboardsGL" in (root / "iso3d" / "src" / "renderer.js").read_text(encoding="utf-8")
assert "getSpriteFrameUV" in (root / "iso3d" / "src" / "host.js").read_text(encoding="utf-8")
assert "right" in (root / "iso3d" / "src" / "math.js").read_text(encoding="utf-8")
