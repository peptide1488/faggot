...
assert "resolveCastCenter" in text
assert "liveOpts" in text
assert "Need a bright cyan tile" in text
assert "attackRange" in (root / "iso3d" / "src" / "host.js").read_text(encoding="utf-8")
